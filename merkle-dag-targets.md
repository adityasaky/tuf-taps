* TAP:
* Title: Content Addressable Systems in TUF
* Version: 1
* Last-Modified:
* Author:
...
define what the length of Merkle DAG objects are. This field may also be entirely
dropped if there is no clear value for a particular ecosystem. The corresponding
POUF must provide a clear direction for populating (or not) this field.
